...
<?php if ($_SESSION['U_ROLE'] == 'Administrator') { ?>
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">List of Users <a href="index.php?view=add" class="btn btn-primary btn-xs  "> <i
				...
				<tbody>
					...
					foreach ($cur as $result) {
						...
						echo '<td align="center" > <a title="Edit" href="index.php?view=edit&id=' . $result->USERID . '"  class="btn btn-primary btn-xs  ">  <span class="fa fa-edit fw-fa"></span></a>
				  					 <a id="delete" title="Delete" href="controller.php?action=delete&id=' . $result->USERID . '" class="btn btn-danger btn-xs" ' . $active . '><span class="fa fa-trash-o fw-fa"></span> </a>
				  					 </td>';
						echo '</tr>';
					}
					?>
...
<?php if ($_SESSION['U_ROLE'] == 'Staff' || $_SESSION['U_ROLE'] == 'Encoder') { ?>
	<h1 class="text-user">Hello <?php echo $_SESSION['U_ROLE']; ?>! </h1>
	<p>You dont have a permission to access this content!</p>
<?php } ?>
